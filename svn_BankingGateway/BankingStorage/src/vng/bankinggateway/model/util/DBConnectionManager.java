...
public class DBConnectionManager {
        ...
        private DBConnectionManager() {
                ...
                if (connectDBImpl == null) {
                        Logger.getLogger("appActions").error(
                                "ConnectDBManager:ConnectDBManager connectDBImpl-Object is null!");
                }
        }
        ...
        public static void main(String[] args) {
                try {
                        Connection conn = DBConnectionManager.getInstance().getConnection(10000);
                } catch (Exception e) {
