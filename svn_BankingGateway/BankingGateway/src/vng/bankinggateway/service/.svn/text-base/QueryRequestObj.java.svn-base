...
public class QueryRequestObj {
    ...
    public String toString() {
        return messageCode + "|" + actionCode + "|" + transactionID + "|" + time 
                ...
                + "|" + moneyCode + "|" + clientIP + "|" + originalTransactionID +"|" + originalTime +"|";
    }

    public QueryRequestObj(String MessageCode, String ActionCode, int TransactionID, 
            String Time, String UserName, String AgencyCode, String ProviderCode, int amount, 
            String moneyCode, String clientIP, int originalTransactionID, String originalTime, String MAC) {
        this.messageCode = MessageCode;
        this.actionCode = ActionCode;
        this.transactionID = TransactionID;
        this.time = Time;
    ...
    public String getScribeMessage() {
        return messageCode + "\t" + actionCode + "\t" + transactionID + "\t" + time 
                ...
                + amount + "\t" + moneyCode + "\t" + clientIP + "\t" + originalTransactionID + "\t" + originalTime +"\t" + MAC + "\t";
    }
}
