 ...
 * created: Apr 18, 2011
 */
public abstract class BankingCore extends HttpServlet {

    private static Logger logger_ = Logger.getLogger(BankingCore.class);
...
//    }
    ...
    protected String applyTemplate(TemplateDataDictionary dic) throws TemplateException {
        TemplateLoader templateLoader = TemplateResourceLoader.create("view/admin/");
        Template template = templateLoader.getTemplate("layout_monitor");
        return template.renderToString(dic);
    }
