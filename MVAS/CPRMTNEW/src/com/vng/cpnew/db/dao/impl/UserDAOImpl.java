...
import com.vng.cpnew.db.dao.UserDAO;
import com.vng.cpnew.db.dao.beans.User;
...
public class UserDAOImpl extends BaseDaoImpl implements UserDAO {
	...
	public int changePassword(Connection connection, int userId, String password)
		...
		String strQuery = "UPDATE " + CPRMTConstants.tblUser
	...
	public User getUserInfoByUserID(Connection connection, int userID)
		...
		String strQuery = "SELECT * FROM " + CPRMTConstants.tblUser
	...
	public int insert(Connection connection, User user) throws Exception {
		...
		String strQuery = "INSERT INTO " + CPRMTConstants.tblUser + " "
