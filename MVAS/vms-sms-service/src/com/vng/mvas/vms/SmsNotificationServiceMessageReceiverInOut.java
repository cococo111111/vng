 ...
 */
        ...
        */
        ...
        SmsNotificationService skel = (SmsNotificationService)obj;
        //Out Envelop
        ...
        if((op.getName() != null) && ((methodName = org.apache.axis2.util.JavaUtils.xmlNameToJavaIdentifier(op.getName().getLocalPart())) != null)){
            ...
            if("notifySmsReception".equals(methodName)){
                ...
                org.csapi.www.schema.parlayx.sms.notification.v2_2.local.NotifySmsReceptionResponseE notifySmsReceptionResponse4 = null;
	                        org.csapi.www.schema.parlayx.sms.notification.v2_2.local.NotifySmsReceptionE wrappedParam =
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                               ...
                                               notifySmsReceptionResponse4 =
                                                   
                                                   
                                                         skel.notifySmsReception(wrappedParam)
                                                    ;
                                            
                                        envelope = toEnvelope(getSOAPFactory(msgContext), notifySmsReceptionResponse4, false, new javax.xml.namespace.QName("http://www.csapi.org/wsdl/parlayx/sms/notification/v2_2/interface",
                                                    "notifySmsReception"));
        ...
        //
            ...
            private  org.apache.axiom.om.OMElement  toOM(cn.com.huawei.www.schema.common.v2_1.NotifySOAPHeaderE param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault {

            
                        try{
                             return param.getOMElement(cn.com.huawei.www.schema.common.v2_1.NotifySOAPHeaderE.MY_QNAME,
                                          org.apache.axiom.om.OMAbstractFactory.getOMFactory());
                        } catch(org.apache.axis2.databinding.ADBException e){
                            throw org.apache.axis2.AxisFault.makeFault(e);
                        }
        ...
        */
        ...
        try {
                ...
                if (cn.com.huawei.www.schema.common.v2_1.NotifySOAPHeaderE.class.equals(type)){
                
                           return cn.com.huawei.www.schema.common.v2_1.NotifySOAPHeaderE.Factory.parse(param.getXMLStreamReaderWithoutCaching());
