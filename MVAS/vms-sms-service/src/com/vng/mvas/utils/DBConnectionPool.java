...
public class DBConnectionPool implements DBConnectionPoolMBean {
    ...
    public DBConnectionPool() {
        ...
        conf.maxIdle = Integer.parseInt(System.getProperty("maxIdle","5"));
        conf.minIdle = 1;
        conf.maxActive = Integer.parseInt(System.getProperty("maxActive","10"));
    ...
    public void invalidateConnection(Connection conn) {
        try {
        	...
        	logger.error("invalidConnection " + ex.getMessage());
        }
    }
