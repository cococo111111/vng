...
public class AdsRMTConstants {
	public final static String BACK_SLASH = "/";
	public final static String DEFAULT_FOLDER = "resources";
	public final static String DB_CONFIG_FILE_NAME = "adsnew_config.properties";

	public final static String COMMAND_CODE_ADS = "COMMAND_CODE_ADS";
	public final static String COMMAND_CODE_ADS_END_MESSAGE = "COMMAND_CODE_ADS_END_MESSAGE";
