...
public abstract class BaseDaoImpl {
	...
	protected Connection getConnection() throws SQLException {
		return AdsRMTServer.getInstance().getConnection();
	}
	...
	protected void rollBackTransation(Connection connection)
			throws SQLException {
		AdsRMTServer.getInstance().rollBackTransaction(connection);
	}
	...
	protected void commitTransation(Connection connection) throws SQLException {
		AdsRMTServer.getInstance().commitTransaction(connection);
	}
