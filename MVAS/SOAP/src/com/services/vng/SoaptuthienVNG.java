...
public class SoaptuthienVNG extends ContentAbstract {
	private static final String className = "com.services.vng.SoaptuthienVNG";
	private static final String TUTHIENVNG_CP_CODE = "VTS";         
