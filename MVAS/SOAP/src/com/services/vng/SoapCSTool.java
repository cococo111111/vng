...
public class SoapCSTool extends ContentAbstract {
	...
	private static final String className = "com.services.vng.SoapCSTool";
	//LACCR = LOCK COUNT CSTOOL: for Real
	private static final String LOCKACCOUNT_CP_CODE = "RPR";
