...
public class SoapG3Gateway extends ContentAbstract {
	private static final String className = "com.services.vng.SoapG3Gateway";
	private static final String TUTHIENVNG_CP_CODE = "SG33";         
	...
	protected Collection getMessages(MsgObject msgObject, Keyword keyword) throws Exception {
		...
		while (iRetries > 0) {
			...
			try {
				...
				Util.logger.info("TimeSendToG3Service:"+ timesend);
				// 202 transaction OK!
				if ("1".equals(result)) {
