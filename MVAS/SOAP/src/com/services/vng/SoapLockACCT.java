...
public class SoapLockACCT extends ContentAbstract {
	...
	private static final String className = "com.services.vng.SoapLockACCT";
	//LACCR = LOCK COUNT CSTOOL: for Real
	private static final String LOCKACCOUNT_CP_CODE = "LACCT";
