...
public class SoapVNGTest extends ContentAbstract {
	private static final String className = "com.services.vng.SoapVNGTest";
	private static final String PAYMMENT_CP_CODE = "SMSPT";
