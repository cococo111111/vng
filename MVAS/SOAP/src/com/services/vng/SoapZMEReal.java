...
public class SoapZMEReal extends ContentAbstract {
	private static final String className = "com.services.vng.SoapZMEReal";
	private static final String ZME_CP_CODE = "ZMER";         
