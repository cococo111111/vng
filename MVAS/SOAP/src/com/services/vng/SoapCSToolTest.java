...
public class SoapCSToolTest extends ContentAbstract {
	...
	private static final String className = "com.services.vng.SoapCSToolTest";
	//LACCR = LOCK COUNT CSTOOL: for Real
	private static final String LOCKACCOUNT_CP_CODE = "TRPR";
