...
public class SoapZingTest extends ContentAbstract {
	private static final String className = "com.services.vng.SoapZingTest";
	private static final String ZP_CP_CODE = "ZPT";
