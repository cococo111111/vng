...
public class SoapFIDOLNew extends ContentAbstract {
	private static final String className = "com.services.vng.SoapFIDOLNew";
	private static final String TUTHIENVNG_CP_CODE = "FIDON";         
