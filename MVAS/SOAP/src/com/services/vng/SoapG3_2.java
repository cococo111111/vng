...
public class SoapG3_2 extends ContentAbstract {
	private static final String className = "com.services.vng.SoapG3_2";
	private static final String TUTHIENVNG_CP_CODE = "SG32";         
	...
	protected Collection getMessages(MsgObject msgObject, Keyword keyword) throws Exception {
		...
		while (iRetries > 0) {
			...
			try {
				...
				Util.logger.info("TimeSendToAcnesService:"+ timesend);
				// 202 transaction OK!
				if ("1".equals(result)) {
