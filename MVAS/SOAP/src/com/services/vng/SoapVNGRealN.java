...
public class SoapVNGRealN extends ContentAbstract {
	...
	private static final String className = "com.services.vng.SoapVNGRealN";
	//SMSPN = Payment Real N: for Real
	private static final String PAYMMENT_CP_CODE = "SMSPN";
