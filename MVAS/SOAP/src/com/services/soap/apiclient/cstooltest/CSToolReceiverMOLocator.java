...
package com.services.soap.apiclient.cstooltest;

public class CSToolReceiverMOLocator extends org.apache.axis.client.Service implements com.services.soap.apiclient.cstooltest.CSToolReceiverMO {
    ...
    private java.lang.String CSToolReceiverMOSoap12_address = "http://10.30.18.214:8000/ReceiverSMSMO/ReceiverSMSMO.svc";
    ...
    public com.services.soap.apiclient.cstooltest.CSToolReceiverMOSoap getCSToolReceiverMOSoap12() throws javax.xml.rpc.ServiceException {
    ...
    public com.services.soap.apiclient.cstooltest.CSToolReceiverMOSoap getCSToolReceiverMOSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.services.soap.apiclient.cstooltest.CSToolReceiverMOSoap12Stub _stub = new com.services.soap.apiclient.cstooltest.CSToolReceiverMOSoap12Stub(portAddress, this);
    ...
    private java.lang.String CSToolReceiverMOSoap_address = "http://10.30.18.214:8000/ReceiverSMSMO/ReceiverSMSMO.svc";
    ...
    public com.services.soap.apiclient.cstooltest.CSToolReceiverMOSoap getCSToolReceiverMOSoap() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public com.services.soap.apiclient.cstooltest.CSToolReceiverMOSoap getCSToolReceiverMOSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.services.soap.apiclient.cstooltest.CSToolReceiverMOSoapStub _stub = new com.services.soap.apiclient.cstooltest.CSToolReceiverMOSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.services.soap.apiclient.cstooltest.CSToolReceiverMOSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.services.soap.apiclient.cstooltest.CSToolReceiverMOSoap12Stub _stub = new com.services.soap.apiclient.cstooltest.CSToolReceiverMOSoap12Stub(new java.net.URL(CSToolReceiverMOSoap12_address), this);
                _stub.setPortName(getCSToolReceiverMOSoap12WSDDServiceName());
                return _stub;
            }
            if (com.services.soap.apiclient.cstooltest.CSToolReceiverMOSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.services.soap.apiclient.cstooltest.CSToolReceiverMOSoapStub _stub = new com.services.soap.apiclient.cstooltest.CSToolReceiverMOSoapStub(new java.net.URL(CSToolReceiverMOSoap_address), this);
                _stub.setPortName(getCSToolReceiverMOSoapWSDDServiceName());
                return _stub;
            }
        }
