...
public class ReceiverMOLocator extends org.apache.axis.client.Service implements com.services.soap.apiclient.zingphoto.ReceiverMO {
    ...
    public com.services.soap.apiclient.zingphoto.ReceiverMOPortType getReceiverMOPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.services.soap.apiclient.zingphoto.ReceiverMOPortType getReceiverMOPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.services.soap.apiclient.zingphoto.ReceiverMOBindingStub _stub = new com.services.soap.apiclient.zingphoto.ReceiverMOBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.services.soap.apiclient.zingphoto.ReceiverMOPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.services.soap.apiclient.zingphoto.ReceiverMOBindingStub _stub = new com.services.soap.apiclient.zingphoto.ReceiverMOBindingStub(new java.net.URL(ReceiverMOPort_address), this);
                _stub.setPortName(getReceiverMOPortWSDDServiceName());
                return _stub;
            }
        }
