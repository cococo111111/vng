...
public class Service1Locator extends org.apache.axis.client.Service implements com.services.soap.apiclient.passport.Service1 {
    ...
    private java.lang.String Service1Soap12_address = "http://localhost:9314/Service1.asmx";
    ...
    public com.services.soap.apiclient.passport.Service1Soap getService1Soap12() throws javax.xml.rpc.ServiceException {
    ...
    public com.services.soap.apiclient.passport.Service1Soap getService1Soap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.services.soap.apiclient.passport.Service1Soap12Stub _stub = new com.services.soap.apiclient.passport.Service1Soap12Stub(portAddress, this);
    ...
    private java.lang.String Service1Soap_address = "http://localhost:9314/Service1.asmx";
    ...
    public com.services.soap.apiclient.passport.Service1Soap getService1Soap() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public com.services.soap.apiclient.passport.Service1Soap getService1Soap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.services.soap.apiclient.passport.Service1SoapStub _stub = new com.services.soap.apiclient.passport.Service1SoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.services.soap.apiclient.passport.Service1Soap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.services.soap.apiclient.passport.Service1Soap12Stub _stub = new com.services.soap.apiclient.passport.Service1Soap12Stub(new java.net.URL(Service1Soap12_address), this);
                _stub.setPortName(getService1Soap12WSDDServiceName());
                return _stub;
            }
            if (com.services.soap.apiclient.passport.Service1Soap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.services.soap.apiclient.passport.Service1SoapStub _stub = new com.services.soap.apiclient.passport.Service1SoapStub(new java.net.URL(Service1Soap_address), this);
                _stub.setPortName(getService1SoapWSDDServiceName());
                return _stub;
            }
        }
