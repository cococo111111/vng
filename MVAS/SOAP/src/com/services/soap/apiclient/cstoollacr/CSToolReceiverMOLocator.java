...
public class CSToolReceiverMOLocator extends org.apache.axis.client.Service implements com.services.soap.apiclient.cstoollacr.CSToolReceiverMO {
    ...
    public com.services.soap.apiclient.cstoollacr.CSToolReceiverMOSoap getCSToolReceiverMOSoap12() throws javax.xml.rpc.ServiceException {
    ...
    public com.services.soap.apiclient.cstoollacr.CSToolReceiverMOSoap getCSToolReceiverMOSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.services.soap.apiclient.cstoollacr.CSToolReceiverMOSoap12Stub _stub = new com.services.soap.apiclient.cstoollacr.CSToolReceiverMOSoap12Stub(portAddress, this);
    ...
    public com.services.soap.apiclient.cstoollacr.CSToolReceiverMOSoap getCSToolReceiverMOSoap() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public com.services.soap.apiclient.cstoollacr.CSToolReceiverMOSoap getCSToolReceiverMOSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.services.soap.apiclient.cstoollacr.CSToolReceiverMOSoapStub _stub = new com.services.soap.apiclient.cstoollacr.CSToolReceiverMOSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.services.soap.apiclient.cstoollacr.CSToolReceiverMOSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.services.soap.apiclient.cstoollacr.CSToolReceiverMOSoap12Stub _stub = new com.services.soap.apiclient.cstoollacr.CSToolReceiverMOSoap12Stub(new java.net.URL(CSToolReceiverMOSoap12_address), this);
                _stub.setPortName(getCSToolReceiverMOSoap12WSDDServiceName());
                return _stub;
            }
            if (com.services.soap.apiclient.cstoollacr.CSToolReceiverMOSoap.class.isAssignableFrom(serviceEndpointInterface)) {
