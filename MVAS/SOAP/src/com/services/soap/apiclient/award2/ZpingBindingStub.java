...
public class ZpingBindingStub extends org.apache.axis.client.Stub implements com.services.soap.apiclient.award2.ZpingPort {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "MobileOperator"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        ...
        oper.setReturnQName(new javax.xml.namespace.QName("", "receiveMOReturn"));
    ...
    public ZpingBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public ZpingBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public ZpingBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    public int receiveMO(java.lang.String requestID, java.lang.String userID, java.lang.String serviceID, java.lang.String commandCode, java.lang.String message, java.lang.String mobileOperator, java.lang.String userName, java.lang.String password, java.lang.String requestTime) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("http://local.awards.zing.vn/webservice/service/zping.php#receiveMO");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("", "receiveMO"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {requestID, userID, serviceID, commandCode, message, mobileOperator, userName, password, requestTime});
  ...
  throw axisFaultException;
    ...
    public int ping() throws java.rmi.RemoteException {
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("http://local.awards.zing.vn/webservice/service/zping.php#ping");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
