...
package com.services.soap.apiclient.cstoolnew;

public class CSToolReceiverMOLocator extends org.apache.axis.client.Service implements com.services.soap.apiclient.cstoolnew.CSToolReceiverMO {
    ...
    private java.lang.String CSToolReceiverMOSoap12_address = "http://10.30.18.119/ReceiverSMSMO04/ReceiverSMSMO.svc";
    ...
    public com.services.soap.apiclient.cstoolnew.CSToolReceiverMOSoap getCSToolReceiverMOSoap12() throws javax.xml.rpc.ServiceException {
    ...
    public com.services.soap.apiclient.cstoolnew.CSToolReceiverMOSoap getCSToolReceiverMOSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.services.soap.apiclient.cstoolnew.CSToolReceiverMOSoap12Stub _stub = new com.services.soap.apiclient.cstoolnew.CSToolReceiverMOSoap12Stub(portAddress, this);
    ...
    private java.lang.String CSToolReceiverMOSoap_address = "http://10.30.18.119/ReceiverSMSMO04/ReceiverSMSMO.svc";
    ...
    public com.services.soap.apiclient.cstoolnew.CSToolReceiverMOSoap getCSToolReceiverMOSoap() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public com.services.soap.apiclient.cstoolnew.CSToolReceiverMOSoap getCSToolReceiverMOSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.services.soap.apiclient.cstoolnew.CSToolReceiverMOSoapStub _stub = new com.services.soap.apiclient.cstoolnew.CSToolReceiverMOSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.services.soap.apiclient.cstoolnew.CSToolReceiverMOSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.services.soap.apiclient.cstoolnew.CSToolReceiverMOSoap12Stub _stub = new com.services.soap.apiclient.cstoolnew.CSToolReceiverMOSoap12Stub(new java.net.URL(CSToolReceiverMOSoap12_address), this);
                _stub.setPortName(getCSToolReceiverMOSoap12WSDDServiceName());
                return _stub;
            }
            if (com.services.soap.apiclient.cstoolnew.CSToolReceiverMOSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.services.soap.apiclient.cstoolnew.CSToolReceiverMOSoapStub _stub = new com.services.soap.apiclient.cstoolnew.CSToolReceiverMOSoapStub(new java.net.URL(CSToolReceiverMOSoap_address), this);
                _stub.setPortName(getCSToolReceiverMOSoapWSDDServiceName());
                return _stub;
            }
        }
