...
public class ReceiverServiceLocator extends org.apache.axis.client.Service implements com.services.soap.apiclient.vmg.ReceiverService {
    ...
    private java.lang.String Receiver_address = "http://203.162.71.82/SMSContentWS/services/Receiver";
    ...
    public com.services.soap.apiclient.vmg.Receiver getReceiver(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.services.soap.apiclient.vmg.ReceiverSoapBindingStub _stub = new com.services.soap.apiclient.vmg.ReceiverSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.services.soap.apiclient.vmg.Receiver.class.isAssignableFrom(serviceEndpointInterface)) {
                com.services.soap.apiclient.vmg.ReceiverSoapBindingStub _stub = new com.services.soap.apiclient.vmg.ReceiverSoapBindingStub(new java.net.URL(Receiver_address), this);
                _stub.setPortName(getReceiverWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://203.162.71.82/SMSContentWS/services/Receiver", "ReceiverService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://203.162.71.82/SMSContentWS/services/Receiver", "Receiver"));
        }
