...
public class ReceiverMOLocator extends org.apache.axis.client.Service implements com.services.soap.apiclient.zingmobile.ReceiverMO {
    ...
    private java.lang.String ReceiverMOPort_address = "http://10.199.43.45/zingsms/ReceiverMO.php";
    ...
    public com.services.soap.apiclient.zingmobile.ReceiverMOPortType getReceiverMOPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.services.soap.apiclient.zingmobile.ReceiverMOPortType getReceiverMOPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.services.soap.apiclient.zingmobile.ReceiverMOBindingStub _stub = new com.services.soap.apiclient.zingmobile.ReceiverMOBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.services.soap.apiclient.zingmobile.ReceiverMOPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.services.soap.apiclient.zingmobile.ReceiverMOBindingStub _stub = new com.services.soap.apiclient.zingmobile.ReceiverMOBindingStub(new java.net.URL(ReceiverMOPort_address), this);
                _stub.setPortName(getReceiverMOPortWSDDServiceName());
                return _stub;
            }
        }
