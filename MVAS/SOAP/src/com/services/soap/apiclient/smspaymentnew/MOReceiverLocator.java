...
public class MOReceiverLocator extends org.apache.axis.client.Service implements com.services.soap.apiclient.smspaymentnew.MOReceiver {
 ...
 */
    ...
    private java.lang.String MOReceiverSoap12_address = "http://10.30.8.241:8787/SMS/MOReceiver_MVAS/MOReceiver.asmx";
    ...
    public com.services.soap.apiclient.smspaymentnew.MOReceiverSoap getMOReceiverSoap12() throws javax.xml.rpc.ServiceException {
    ...
    public com.services.soap.apiclient.smspaymentnew.MOReceiverSoap getMOReceiverSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.services.soap.apiclient.smspaymentnew.MOReceiverSoap12Stub _stub = new com.services.soap.apiclient.smspaymentnew.MOReceiverSoap12Stub(portAddress, this);
    ...
    private java.lang.String MOReceiverSoap_address = "http://10.30.8.241:8787/SMS/MOReceiver_MVAS/MOReceiver.asmx";
    ...
    public com.services.soap.apiclient.smspaymentnew.MOReceiverSoap getMOReceiverSoap() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public com.services.soap.apiclient.smspaymentnew.MOReceiverSoap getMOReceiverSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.services.soap.apiclient.smspaymentnew.MOReceiverSoapStub _stub = new com.services.soap.apiclient.smspaymentnew.MOReceiverSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.services.soap.apiclient.smspaymentnew.MOReceiverSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.services.soap.apiclient.smspaymentnew.MOReceiverSoap12Stub _stub = new com.services.soap.apiclient.smspaymentnew.MOReceiverSoap12Stub(new java.net.URL(MOReceiverSoap12_address), this);
                _stub.setPortName(getMOReceiverSoap12WSDDServiceName());
                return _stub;
            }
            if (com.services.soap.apiclient.smspaymentnew.MOReceiverSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.services.soap.apiclient.smspaymentnew.MOReceiverSoapStub _stub = new com.services.soap.apiclient.smspaymentnew.MOReceiverSoapStub(new java.net.URL(MOReceiverSoap_address), this);
                _stub.setPortName(getMOReceiverSoapWSDDServiceName());
                return _stub;
            }
        }
