...
public class ReceiverMOLocator extends org.apache.axis.client.Service implements com.services.soap.apiclient.zingme.ReceiverMO {
    ...
    public com.services.soap.apiclient.zingme.ReceiverMOPortType getReceiverMOPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.services.soap.apiclient.zingme.ReceiverMOPortType getReceiverMOPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.services.soap.apiclient.zingme.ReceiverMOBindingStub _stub = new com.services.soap.apiclient.zingme.ReceiverMOBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.services.soap.apiclient.zingme.ReceiverMOPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.services.soap.apiclient.zingme.ReceiverMOBindingStub _stub = new com.services.soap.apiclient.zingme.ReceiverMOBindingStub(new java.net.URL(ReceiverMOPort_address), this);
                _stub.setPortName(getReceiverMOPortWSDDServiceName());
                return _stub;
            }
        }
