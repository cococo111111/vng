/**
 * ReceiveMOZingAwardBindingStub.java
 *
...
public class ReceiveMOZingAwardBindingStub extends org.apache.axis.client.Stub implements com.services.soap.apiclient.award.ReceiveMOZingAwardPortType {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "MoblieOperator"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
    ...
    public ReceiveMOZingAwardBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public ReceiveMOZingAwardBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public ReceiveMOZingAwardBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    public int receiveMO(java.lang.String requestID, java.lang.String userID, java.lang.String serviceID, java.lang.String commandCode, java.lang.String message, java.lang.String moblieOperator, java.lang.String userName, java.lang.String password, java.util.Calendar requestTime) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("urn:ReceiveMOZingAward#receiveMO");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:ReceiveMOZingAward", "receiveMO"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {requestID, userID, serviceID, commandCode, message, moblieOperator, userName, password, requestTime});
