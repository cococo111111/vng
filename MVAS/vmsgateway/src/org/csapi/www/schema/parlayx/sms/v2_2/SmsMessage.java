...
public class SmsMessage  implements java.io.Serializable {
    ...
    /**
     * Gets the dateTime value for this SmsMessage.
     * 
     * @return dateTime
     */
    ...
    /**
     * Sets the dateTime value for this SmsMessage.
     * 
     * @param dateTime
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.csapi.org/schema/parlayx/sms/v2_2", "SmsMessage"));
