...
public class SMSData
{
    ...
    public boolean rebuildMobileOperator()
    {
        ...
        if(userId.startsWith("98") || userId.startsWith("098") || userId.startsWith("8498"))
        {
