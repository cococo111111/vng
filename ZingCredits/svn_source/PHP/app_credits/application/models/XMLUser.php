...
{   	
	...
	{			
		...
		{  
			...
			$appid = $user->getElementsByTagName( "appid" );
			$appid = $appid->item(0)->nodeValue;

			$appname = $user->getElementsByTagName( "appname" );
			$appname = $appname->item(0)->nodeValue;
...
//       	$result->userrole = $identity["userrole"];
    ...
    {		
    	try 
    	{
			...
			$appid = $getUser->getElementsByTagName( "appid" );
			$appid = $appid->item(0)->nodeValue;
			
			$appname = $getUser->getElementsByTagName( "appname" );
			$appname = $appname->item(0)->nodeValue;
