...
import com.vng.zing.credits.report.mail.util.string.SecurityHelper;
...
public abstract class CoreAction extends HttpServlet {
    ...
    protected TemplateDataDictionary getDictionary() {
        ...
        dic.setVariable("app_url", Config.getParam("REPORT", "app_url"));
        return dic;
    }
...
//        if (admin_auth_role != null && (Config.getParam("REPORT", "sysadmin").equals(admin_auth_role) || Config.getParam("REPORT", "admin").equals(admin_auth_role))) {
//            if (SecurityHelper.md5(admin_auth_key + admin_auth_role + Config.getParam("REPORT", "sign_key")).equals(admin_auth_sign_key)) {
//                return true;
//            }
//        }
//        return false;
