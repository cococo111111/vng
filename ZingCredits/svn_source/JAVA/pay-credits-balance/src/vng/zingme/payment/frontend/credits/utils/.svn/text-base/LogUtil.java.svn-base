...
public class LogUtil {
	...
	public static void init(String path) {
		String file = path + File.separator + "log4j.properties";
	...
	public static String throwableToString(Throwable e) {
		...
		sbuf.append((new StringBuilder()).append("Exception was generated at : ").append(getTimestamp()).append(" on thread ").append(
