...
public class Configuration {
    ...
    //QuyTP
    public static Properties APP_URLS;
    //End QuyTP
    ...
    //QuyTP
    public static void loadAppUrls() throws Exception {
        Properties properties = new Properties();
        properties.load(new FileInputStream(System.getProperty("config") + "/app_urls.ini"));
        APP_URLS = properties;
    }
    //End QuyTP
}
