...
#add options for jmxremote
#JAVA_OPTS="$JAVA_OPTS -Dconfig=/zserver/java/apache-tomcat-7.0.8/conf -Djava.rmi.server.hostname=localhost -Dcom.sun.management.jmxremote.port=9874 -Dcom.sun.management.jmxremote.ssl=false -Dcom.sun.management.jmxremote.authenticate=false"

JAVA_OPTS="$JAVA_OPTS -Xms512m -Xmx1g -Dconfig=/zserver/java/apache-tomcat-7.0.8/conf"
