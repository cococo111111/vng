...
public class TimedStatsDeque extends AbstractStatsDeque {
	...
	public synchronized Iterator<Double> iterator() {
		purge();
		// I expect this method to be called relatively infrequently so
		// inefficiency is ok.
		// (this has the side benefit of making iteration threadsafe w/o having
		// to use LinkedBlockingDeque.)
