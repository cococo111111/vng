...
public class T_Transaction implements TBase<T_Transaction, T_Transaction._Fields>, java.io.Serializable, Cloneable {
  ...
  private static final TField BALANCES_FIELD_DESC = new TField("balances", TType.MAP, (short)19);
  private static final TField WALLET_TX_ID_FIELD_DESC = new TField("walletTxID", TType.I64, (short)20);
  ...
  public Map<Short,Double> balances;
  public long walletTxID;
  ...
  public enum _Fields implements TFieldIdEnum {
    ...
    BALANCES((short)19, "balances"),
    WALLET_TX_ID((short)20, "walletTxID");
  ...
  private static final int __WALLETTXID_ISSET_ID = 8;
  ...
  static {
    ...
    tmpMap.put(_Fields.CLIENT_IP, new FieldMetaData("clientIP", TFieldRequirementType.DEFAULT, 
        new FieldValueMetaData(TType.STRING)));
    tmpMap.put(_Fields.BALANCES, new FieldMetaData("balances", TFieldRequirementType.DEFAULT, 
        new MapMetaData(TType.MAP, 
            new FieldValueMetaData(TType.I16), 
            new FieldValueMetaData(TType.DOUBLE))));
    tmpMap.put(_Fields.WALLET_TX_ID, new FieldMetaData("walletTxID", TFieldRequirementType.DEFAULT, 
        new FieldValueMetaData(TType.I64)));
  ...
  public T_Transaction(T_Transaction other) {
    ...
    if (other.isSetBalances()) {
      Map<Short,Double> __this__balances = new HashMap<Short,Double>();
      for (Map.Entry<Short, Double> other_element : other.balances.entrySet()) {

        Short other_element_key = other_element.getKey();
        Double other_element_value = other_element.getValue();

        Short __this__balances_copy_key = other_element_key;

        Double __this__balances_copy_value = other_element_value;

        __this__balances.put(__this__balances_copy_key, __this__balances_copy_value);
      }
      this.balances = __this__balances;
    }
    this.walletTxID = other.walletTxID;
  }
  ...
  public void putToBalances(short key, double val) {
    if (this.balances == null) {
      this.balances = new HashMap<Short,Double>();
    }
    this.balances.put(key, val);
  }

  public Map<Short,Double> getBalances() {
    return this.balances;
  }

  public T_Transaction setBalances(Map<Short,Double> balances) {
    this.balances = balances;
    return this;
  }
  ...
  /** Returns true if field balances is set (has been asigned a value) and false otherwise */
  ...
  public T_Transaction setWalletTxID(long walletTxID) {
    this.walletTxID = walletTxID;
    setWalletTxIDIsSet(true);
    return this;
  }

  public void unsetWalletTxID() {
    __isset_bit_vector.clear(__WALLETTXID_ISSET_ID);
  }

  /** Returns true if field walletTxID is set (has been asigned a value) and false otherwise */
  public boolean isSetWalletTxID() {
    return __isset_bit_vector.get(__WALLETTXID_ISSET_ID);
  }

  public void setWalletTxIDIsSet(boolean value) {
    __isset_bit_vector.set(__WALLETTXID_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case BALANCES:
      if (value == null) {
        ...
        setBalances((Map<Short,Double>)value);
      }
      break;
  ...
  public boolean equals(T_Transaction that) {
    ...
    boolean this_present_walletTxID = true;
    boolean that_present_walletTxID = true;
    if (this_present_walletTxID || that_present_walletTxID) {
      if (!(this_present_walletTxID && that_present_walletTxID))
        return false;
      if (this.walletTxID != that.walletTxID)
        return false;
    }
  ...
  public int compareTo(T_Transaction other) {
    ...
    lastComparison = Boolean.valueOf(isSetBalances()).compareTo(typedOther.isSetBalances());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBalances()) {
      lastComparison = TBaseHelper.compareTo(this.balances, typedOther.balances);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetWalletTxID()).compareTo(typedOther.isSetWalletTxID());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetWalletTxID()) {
      lastComparison = TBaseHelper.compareTo(this.walletTxID, typedOther.walletTxID);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
          ...
          if (field.type == TType.MAP) {
            {
              ...
              this.balances = new HashMap<Short,Double>(2*_map0.size);
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.balances != null) {
      ...
      {
        oprot.writeMapBegin(new TMap(TType.I16, TType.DOUBLE, this.balances.size()));
        for (Map.Entry<Short, Double> _iter4 : this.balances.entrySet())
        {
    ...
    oprot.writeFieldBegin(WALLET_TX_ID_FIELD_DESC);
    oprot.writeI64(this.walletTxID);
    oprot.writeFieldEnd();
  ...
  public String toString() {
    ...
    first = false;
    if (!first) sb.append(", ");
    sb.append("walletTxID:");
    sb.append(this.walletTxID);
    first = false;
    sb.append(")");
    return sb.toString();
  }
