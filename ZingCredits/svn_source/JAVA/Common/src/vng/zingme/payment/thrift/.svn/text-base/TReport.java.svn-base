  ...
  public static class getTransStatus_result implements TBase<getTransStatus_result, getTransStatus_result._Fields>, java.io.Serializable, Cloneable   {
            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.success = new ArrayList<vng.zingme.payment.thrift.T_ReportTransaction>(_list24.size);
                for (int _i25 = 0; _i25 < _list24.size; ++_i25)
                {
                  vng.zingme.payment.thrift.T_ReportTransaction _elem26;
                  _elem26 = new vng.zingme.payment.thrift.T_ReportTransaction();
                  _elem26.read(iprot);
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.isSetSuccess()) {
        ...
        {
          oprot.writeListBegin(new TList(TType.STRUCT, this.success.size()));
          for (vng.zingme.payment.thrift.T_ReportTransaction _iter27 : this.success)
          {
            _iter27.write(oprot);
          }
          oprot.writeListEnd();
  ...
  public static class summaryDaily_result implements TBase<summaryDaily_result, summaryDaily_result._Fields>, java.io.Serializable, Cloneable   {
            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.success = new ArrayList<vng.zingme.payment.thrift.T_ReportSummary>(_list28.size);
                for (int _i29 = 0; _i29 < _list28.size; ++_i29)
                {
                  vng.zingme.payment.thrift.T_ReportSummary _elem30;
                  _elem30 = new vng.zingme.payment.thrift.T_ReportSummary();
                  _elem30.read(iprot);
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.isSetSuccess()) {
        ...
        {
          oprot.writeListBegin(new TList(TType.STRUCT, this.success.size()));
          for (vng.zingme.payment.thrift.T_ReportSummary _iter31 : this.success)
          {
            _iter31.write(oprot);
          }
          oprot.writeListEnd();
