...
public class TAppServer {
  ...
  public interface Iface {
    ...
    public void addIdsToWhitelist(String appID, List<Integer> lsUserID) throws TException;
  ...
  public interface AsyncIface {
    ...
    public void addIdsToWhitelist(String appID, List<Integer> lsUserID, AsyncMethodCallback<AsyncClient.addIdsToWhitelist_call> resultHandler) throws TException;
  ...
  public static class Client implements TServiceClient, Iface {
    ...
    public void addIdsToWhitelist(String appID, List<Integer> lsUserID) throws TException
    {
      send_addIdsToWhitelist(appID, lsUserID);
      recv_addIdsToWhitelist();
    }

    public void send_addIdsToWhitelist(String appID, List<Integer> lsUserID) throws TException
    {
  ...
  public static class AsyncClient extends TAsyncClient implements AsyncIface {
    ...
    public void addIdsToWhitelist(String appID, List<Integer> lsUserID, AsyncMethodCallback<addIdsToWhitelist_call> resultHandler) throws TException {
      checkReady();
      addIdsToWhitelist_call method_call = new addIdsToWhitelist_call(appID, lsUserID, resultHandler, this, protocolFactory, transport);
      manager.call(method_call);
    }

    public static class addIdsToWhitelist_call extends TAsyncMethodCall {
      private String appID;
      private List<Integer> lsUserID;
      public addIdsToWhitelist_call(String appID, List<Integer> lsUserID, AsyncMethodCallback<addIdsToWhitelist_call> resultHandler, TAsyncClient client, TProtocolFactory protocolFactory, TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.appID = appID;
  ...
  public static class Processor implements TProcessor {
    ...
    private class addIdsToWhitelist implements ProcessFunction {
      public void process(int seqid, TProtocol iprot, TProtocol oprot) throws TException
      {
        ...
        iprot.readMessageEnd();
        addIdsToWhitelist_result result = new addIdsToWhitelist_result();
        iface_.addIdsToWhitelist(args.appID, args.lsUserID);
...
;
  ...
  public static class addIdsToWhitelist_args implements TBase<addIdsToWhitelist_args, addIdsToWhitelist_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    private static final TField APP_ID_FIELD_DESC = new TField("appID", TType.STRING, (short)1);
    private static final TField LS_USER_ID_FIELD_DESC = new TField("lsUserID", TType.LIST, (short)2);

    public String appID;
    public List<Integer> lsUserID;

    /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
    public enum _Fields implements TFieldIdEnum {
      APP_ID((short)1, "appID"),
      LS_USER_ID((short)2, "lsUserID");
    ...
    static {
      ...
      tmpMap.put(_Fields.APP_ID, new FieldMetaData("appID", TFieldRequirementType.DEFAULT, 
          new FieldValueMetaData(TType.STRING)));
      tmpMap.put(_Fields.LS_USER_ID, new FieldMetaData("lsUserID", TFieldRequirementType.DEFAULT, 
          new ListMetaData(TType.LIST, 
              new FieldValueMetaData(TType.I32))));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
    ...
    public addIdsToWhitelist_args(addIdsToWhitelist_args other) {
      ...
      if (other.isSetLsUserID()) {
        List<Integer> __this__lsUserID = new ArrayList<Integer>();
        for (Integer other_element : other.lsUserID) {
          __this__lsUserID.add(other_element);
        }
        this.lsUserID = __this__lsUserID;
      }
    }
    ...
    public int getLsUserIDSize() {
      return (this.lsUserID == null) ? 0 : this.lsUserID.size();
    }

    public java.util.Iterator<Integer> getLsUserIDIterator() {
      return (this.lsUserID == null) ? null : this.lsUserID.iterator();
    }

    public void addToLsUserID(int elem) {
      if (this.lsUserID == null) {
        this.lsUserID = new ArrayList<Integer>();
      }
      this.lsUserID.add(elem);
    }

    public List<Integer> getLsUserID() {
      return this.lsUserID;
    }

    public addIdsToWhitelist_args setLsUserID(List<Integer> lsUserID) {
      this.lsUserID = lsUserID;
      return this;
    }

    public void unsetLsUserID() {
      this.lsUserID = null;
    }

    /** Returns true if field lsUserID is set (has been asigned a value) and false otherwise */
    public boolean isSetLsUserID() {
      return this.lsUserID != null;
    }

    public void setLsUserIDIsSet(boolean value) {
      if (!value) {
        this.lsUserID = null;
      }
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case LS_USER_ID:
        if (value == null) {
          ...
          setLsUserID((List<Integer>)value);
        }
        break;
    ...
    public boolean equals(addIdsToWhitelist_args that) {
      ...
      boolean this_present_lsUserID = true && this.isSetLsUserID();
      boolean that_present_lsUserID = true && that.isSetLsUserID();
      if (this_present_lsUserID || that_present_lsUserID) {
        if (!(this_present_lsUserID && that_present_lsUserID))
          return false;
        if (!this.lsUserID.equals(that.lsUserID))
          return false;
      }
    ...
    public int compareTo(addIdsToWhitelist_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetLsUserID()).compareTo(typedOther.isSetLsUserID());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetLsUserID()) {
        lastComparison = TBaseHelper.compareTo(this.lsUserID, typedOther.lsUserID);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.lsUserID = new ArrayList<Integer>(_list12.size);
                for (int _i13 = 0; _i13 < _list12.size; ++_i13)
                {
                  int _elem14;
                  _elem14 = iprot.readI32();
                  this.lsUserID.add(_elem14);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.lsUserID != null) {
        oprot.writeFieldBegin(LS_USER_ID_FIELD_DESC);
        {
          oprot.writeListBegin(new TList(TType.I32, this.lsUserID.size()));
          for (int _iter15 : this.lsUserID)
          {
