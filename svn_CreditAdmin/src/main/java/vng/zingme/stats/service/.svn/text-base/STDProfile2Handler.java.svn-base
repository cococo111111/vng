...
public class STDProfile2Handler implements StdProfile2Service_Rd.Iface {
	...
	private STDProfile2Handler(String host, int port) {
		_adminClient = new GenericObjectPool(
				new STDProfile2Factory(host, port),
				TClientPoolConfig
						.ClonePoolConfig(TClientPoolConfig.DefaultPoolConfig));
	}
	...
	public static STDProfile2Handler getMainInstance() {
		if (_mainInstance == null) {
			synchronized (lockObj) {
				if (_mainInstance == null) {
					String adHost = System
							.getProperty("adminHost", "localhost");
	...
	public <T, K> T exec(Command<T, StdProfile2Service_Rd.Client> command,
			T defaultValue) {
		StdProfile2Service_Rd.Client client = null;
		try {
	...
	public TValueResult get(final OpHandle oh, final int i) throws ZException,
			TException {
		Command<TValueResult, StdProfile2Service_Rd.Client> command = new Command<TValueResult, StdProfile2Service_Rd.Client>() {

			@Override
			public TValueResult exec(StdProfile2Service_Rd.Client client)
					throws Exception {
	...
	public TMapDataResult multiGet(OpHandle oh, List<Integer> list)
			throws ZException, TException {
		throw new UnsupportedOperationException("Not supported yet.");
	}

	public TMapErrorResult multiExist(OpHandle oh, List<Integer> list)
			throws ZException, TException {
		throw new UnsupportedOperationException("Not supported yet.");
	}

	public TValueResult getFrom(OpHandle oh, int i, String string)
			throws ZException, TException {
		throw new UnsupportedOperationException("Not supported yet.");
	}

	public TMapDataResult multiGetFrom(OpHandle oh, List<Integer> list,
			String string) throws ZException, TException {
		throw new UnsupportedOperationException("Not supported yet.");
	}

	public TUIDResult getUID(final OpHandle oh, final String string)
			throws ZException, TException {
		Command<TUIDResult, StdProfile2Service_Rd.Client> command = new Command<TUIDResult, StdProfile2Service_Rd.Client>() {

			@Override
			public TUIDResult exec(StdProfile2Service_Rd.Client client)
					throws Exception {
	...
	public TMapNameIDResult multiGetUID(OpHandle oh, List<String> list)
			throws ZException, TException {
		throw new UnsupportedOperationException("Not supported yet.");
	}

	public TValueResult getByName(OpHandle oh, String string)
			throws ZException, TException {
		throw new UnsupportedOperationException("Not supported yet.");
	}

	public TMapNameDataResult multiGetByName(OpHandle oh, List<String> list)
			throws ZException, TException {
		throw new UnsupportedOperationException("Not supported yet.");
	}

	public TValueResult getNameAvatar(OpHandle oh, int i) throws ZException,
			TException {
		throw new UnsupportedOperationException("Not supported yet.");
	}

	public TMapDataResult multiGetNameAvatar(OpHandle oh, List<Integer> list)
			throws ZException, TException {
		throw new UnsupportedOperationException("Not supported yet.");
	}
	...
	public TValueResult getCertNameAvatar(OpHandle oh, int i)
			throws ZException, TException {
		throw new UnsupportedOperationException("Not supported yet.");
	}

	public TMapDataResult multiGetCertNameAvatar(OpHandle oh, List<Integer> list)
			throws ZException, TException {
		throw new UnsupportedOperationException("Not supported yet.");
	}
}
